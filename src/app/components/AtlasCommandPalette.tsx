...
const RESULTS: AtlasResult[] = [
  ...
  { id: "sovereign-ux", title: "Sovereign UX", kind: "framework", type: "FRAMEWORK", parent: "DESIGN METHODS", description: "Designing for consent, reflection, and human authority.", keywords: ["sovereign ux", "consent", "reflection", "authority", "trust", "echo", "reflection", "echo layer", "reflection layer"] },
