  ...
  return (
    ...
    >
        ...
        {!active && !reducedMotion && (
          <>
            ...
            <animate
              ...
              values={`${0.045 * intensity};${0.12 * intensity};${0.045 * intensity}`}
              dur="3.8s"
              begin={pulseDelay}
              repeatCount="indefinite"
            />
      ...
      <circle
        cx={x}
        cy={y}
        r={(active ? 10 : 9) * nodeScale}
        fill={nodeColor}
        opacity={active ? 0.26 : 0.18}
        filter="url(#fo-glow-sm)"
        style={{ transition }}
      >
        {!active && !reducedMotion && (
      ...
      <circle
        cx={x}
        cy={y}
        r={(active ? 6.2 : 4.7) * nodeScale}
        fill={nodeColor}
        opacity={Math.min(1, (active ? 0.98 : 0.86) * intensity)}
        filter="url(#fo-glow-sm)"
        style={{ transition }}
      >
        {!active && !reducedMotion && (
          <>
            ...
            <animate
              attributeName="opacity"
              values={`${0.72 * intensity};${Math.min(1, 0.96 * intensity)};${0.72 * intensity}`}
              dur="3.8s"
              begin={pulseDelay}
              repeatCount="indefinite"
            />
